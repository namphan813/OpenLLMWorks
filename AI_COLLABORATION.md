...
Every significant architectural decision has been reviewed by the project's maintainers.

Every code contribution is expected to be understood before it is accepted.
...
The goal of using AI is not to replace engineering judgment.

The goal is to accelerate thoughtful engineering while maintaining transparency, accountability, and code quality.
